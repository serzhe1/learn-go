...
It is assumed that you have read the [structs section](https://quii.gitbook.io/learn-go-with-tests/go-fundamentals/structs-methods-and-interfaces) before as some understanding of interfaces will be needed for this.
